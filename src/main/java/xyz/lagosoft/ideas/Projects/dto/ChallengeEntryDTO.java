...
public class ChallengeEntryDTO {
    ...
    public String getSdgSlugs() {
        return sdgSlugs;
    }

    public void setSdgSlugs(String sdgSlugs) {
        this.sdgSlugs = sdgSlugs;
    }
    ...
    public List<String> getSDGSlugList() {
        return Splitter.on(',')
                .trimResults()
                .omitEmptyStrings()
                .splitToList(sdgSlugs);
    }
